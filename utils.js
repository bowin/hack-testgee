...
var path_128 = [[-17,-20,0],[0,0,0],[1,0,1186],[2,0,1225],[3,0,1273],[3,0,1313],[4,0,1338],[7,0,1355],[11,0,1372],[16,0,1389],[21,0,1407],[26,1,1425],[30,1,1441],[34,1,1458],[36,1,1475],[40,1,1492],[42,1,1509],[45,1,1527],[48,1,1545],[50,1,1562],[52,1,1579],[54,1,1596],[56,1,1613],[58,1,1631],[60,1,1648],[63,1,1665],[66,1,1683],[68,1,1700],[70,1,1719],[72,1,1736],[73,1,1753],[75,1,1769],[77,1,1787],[79,1,1803],[81,1,1820],[83,1,1838],[85,1,1855],[87,1,1873],[91,1,1890],[94,1,1907],[97,1,1924],[100,1,1942],[104,1,1959],[106,0,1977],[109,0,1994],[111,0,2012],[113,0,2029],[115,0,2046],[116,0,2064],[117,0,2081],[118,0,2099],[118,-1,2130],[120,-1,2433],[120,-1,2481],[121,-1,2506],[122,-1,2523],[123,-1,2541],[125,-1,2558],[126,-1,2576],[127,-1,2593],[128,-1,2610],[129,-1,2642],[128,-1,3073],[127,-1,3218],[127,-1,3529]];
...
co(function*() {
  ...
  // post
  P.e[a.id].arr = path_183.filter(arr=> arr[0] <= Math.floor(0.5 * (offset.x - 6)));

  while (P.e[a.id].arr.slice(-1)[0][0] < Math.floor(0.8*(offset.x - 6))){
    P.e[a.id].arr.push([P.e[a.id].arr.slice(-1)[0][0] +2, 0, P.e[a.id].arr.slice(-1)[0][2] + 23]);
  }
  while (P.e[a.id].arr.slice(-1)[0][0] < offset.x - 6) {
    P.e[a.id].arr.push([P.e[a.id].arr.slice(-1)[0][0] + Math.floor(Math.random()+1), 0, P.e[a.id].arr.slice(-1)[0][2] + Math.floor(Math.random()*(30-15)+15)]);
  }
  console.log(JSON.stringify(P.e[a.id].arr,null,2));
